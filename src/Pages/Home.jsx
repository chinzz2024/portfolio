...
const TECH_STACK = ["React", "Node", "Flutter", "MongoDB"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/chinzz2024" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/pranav-mohan-083245239/" },
  { icon: Instagram, link: "https://www.instagram.com/_pranavmohan?igsh=MTM4YW0ycGRjbGV5cw==" }
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0" data-aos="fade-right" data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6">
                ...
                Delivering Robust, Clean, and Scalable Web Solutions.
                </p>
