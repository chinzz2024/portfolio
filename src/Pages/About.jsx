...
// --- THE FIX: STEP 1 - Import the data from our central file ---
// This ensures the numbers are always correct.
import { projectsData, certificatesData } from "../projectData"; // Adjust path if needed
    ...
    >
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <img
            src="/Photo.jpg" // Assuming Photo.jpg is in your `public` folder
            alt="Profile"
...
const AboutPage = () => {
    // --- THE FIX: STEP 2 - Read data directly from the imported arrays ---
    const totalProjects = projectsData.length;
    const totalCertificates = certificatesData.length;
    // Note: Years of experience logic is kept separate as it's a calculation
    const YearExperience = 0; // You can update this value directly
    ...
    const statsData = useMemo(() => [
        {
            ...
            value: totalProjects, // This is now correct
        ...
        },
        {
            ...
            value: totalCertificates, // This is now correct
            label: "Certificates",
                ...
                <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        <p 
                            ...
                            data-aos-duration="1500"
                        >
                            Computer Science graduate with a passion for crafting intuitive and visually appealing digital experiences. Skilled in full-stack development, I enjoy blending creativity with technical expertise to deliver impactful and user-focused solutions. I am committed to continuous learning and bringing innovation to every project I undertake.
                        </p>
                        ...
                        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
                            <a href="/PRANAVMOHAN_RESUME.pdf" className="w-full lg:w-auto">
                                <button 
                                    data-aos="fade-up"
                                    data-aos-duration="800"
