  ...
  return (
    <div className={cardClassName}>
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <RouterLink to={`/project/${id}`} className="rounded-full bg-slate-800/70 px-4 py-2 text-sm font-semibold text-slate-200 transition-colors hover:bg-violet-600">Details</RouterLink>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
        <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
            <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">Portfolio Showcase</h2>
