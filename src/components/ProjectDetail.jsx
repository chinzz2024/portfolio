...
const projectsData = [
  {
    ...
    Link: "https://github.com/chinzz2024/FOLIOX_ORG.git",
    Github: "https://github.com/chinzz2024/FOLIOX_ORG.git",
  ...
  },
  {
    ...
    Link: "https://github.com/chinzz2024/Farmers_portal.git",
    Github: "https://github.com/chinzz2024/Farmers_portal.git",
  ...
  },
  {
    ...
    Link: "https://github.com/chinzz2024/inventorysys",
    Github: "https://github.com/chinzz2024/inventorysys",
...
const ProjectDetails = () => {
    ...
    return (
        <div className="min-h-screen bg-[#030014] px-[2%] sm:px-0 relative overflow-hidden">
            <div className="fixed inset-0"><div className="absolute -inset-[10px] opacity-20"><div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" /><div className="absolute top-0 -right-4 w-72 md:w-96 h-72 md:h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000" /><div className="absolute -bottom-8 left-20 w-72 md:w-96 h-72 md:h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000" /></div><div className="absolute inset-0 bg-[url('/grid.svg')] opacity-[0.02]" /></div>
